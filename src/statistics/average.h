...
*/
#ifndef STATISTICSAVERAGE_H
#define STATISTICSAVERAGE_H
...
/**
* Implements the statistic of average - given a set of values returns the adding.
* @see the statisticalestimator class
*/
class Average : public StatisticalEstimator{
public:
  Average();
  ~Average();
