...
*/
#ifndef STATISTICSMIN_H
#define STATISTICSMIN_H
...
/** 
* Implements the statistic of min- given a set of values returns the minimun of all the values. Can be applied to vectors of integers or doubles 
* @see the statisticalestimator class
*/
class Min : public StatisticalEstimator {
public:
  Min();
  ~Min();
